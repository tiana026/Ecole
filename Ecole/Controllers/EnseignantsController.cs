...
namespace Ecole.Controllers
{
    public class EnseignantsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Nom,Postnom,Prenom,Sexe,Telephone,Email")] Enseignant enseignant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nom,Postnom,Prenom,Sexe,Telephone,Email")] Enseignant enseignant)
        {
            if (ModelState.IsValid)
            {
