...
namespace Ecole.Controllers
{
    public class PeriodesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,NomPeriode,Moyenne")] Periode periode)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,NomPeriode,Moyenne")] Periode periode)
        {
            if (ModelState.IsValid)
            {
